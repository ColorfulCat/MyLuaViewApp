package com.devis.myluaviewapp.provider;
...
public class GlideImageProvider implements ImageProvider {
    ...
    @Override
    public void load(Context context, WeakReference<BaseImageView> imageView, String url, WeakReference<BaseImageView.LoadCallback> callback) {
